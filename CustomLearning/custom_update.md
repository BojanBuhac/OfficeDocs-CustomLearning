...
1.	Go to the [GitHub custom learning repository](https://github.com/ComputermanIT/Microsoft-365-Learning-Pathways/tree/main/installation), select **customlearning.sppkg** and then download it to a local drive on your PC.
